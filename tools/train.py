...
from encdec.core.function import train, validate
import math
from encdec.core.criterion import CrossEntropy, OhemCrossEntropy, MeanSquaredError, MeanAbsError
...
def main():
    ...
    # criterion
    criterion = MeanSquaredError() if config.LOSS.FUNCTION == 'mse' else MeanAbsError()
    ...
    for epoch in range(last_epoch, end_epoch):
        ...
        if args.local_rank <= 0:
            ...
            msg = 'Val Loss: {}, Best Val Loss: {}'.format(valid_loss, best_val_loss)
            logging.info(msg)
